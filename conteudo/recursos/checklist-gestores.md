---
title: "Checklist da Jornada de Contratação de IA na Educação"
...
Este checklist acompanha a jornada de contratação de soluções de IA educacional em três fases. Use-o como instrumento de verificação e acompanhamento: nem todos os itens se aplicam a todos os contextos, mas cada um representa uma boa prática identificada na pesquisa e na literatura nacional e internacional.
...
Considere intervir ou acionar as cláusulas de saída se:

- [ ] A EdTech não fornece documentação técnica solicitada
- [ ] Professores relatam que não conseguem anular sugestões da IA
- [ ] Resultados dos alunos pioraram ou há sinais de "preguiça cognitiva"
- [ ] Houve incidente de segurança de dados sem resposta adequada do fornecedor
- [ ] A solução gera resultados sistematicamente enviesados para determinados grupos
